...
var conf = Conf{
	ClientId:     "c4d861db163acb1b462e",
	ClientSecret: "cc4d60391d6ce3e4555bf6170c539657050a6768",
	RedirectUrl:  "http://127.0.0.1:8080/home",
}
...
func GetTokenAuthUrl(code string) string {
	return fmt.Sprintf(
		"https://github.com/login?client_id=%s&client_secret=%s&code=%s",
